function createPostList__itemEl(dateCreated, authorName, title, excerpt, url, tagListEl) {
    ...
    postList__authorName.appendChild(document.createTextNode(
        authorName
    ))
    ...
    postList__dateCreatedEl.appendChild(
        document.createTextNode(dateCreated)
    )
