...
export function addAppBar() {
  ...
  appBar__layoutEl.appendChild(
    createNavigationEl(navLinks, "navigation", "navigation__link")
  );
  ...
  appBarEl.appendChild(
    createNavigationEl(navLinks, "mobile-navigation", "mobile-navigation__link")
  );
}
